...
router.post('/saveworkingtimer', function(req, res, next){
	...
	req.body.endedtime = moment(req.body.endedtime, 'hh:mm:ss A').valueOf();
	req.body.startedtime = moment(req.body.startedtime, 'hh:mm:ss A').valueOf();

	var durationStamp = parseInt(req.body.endedtime - req.body.startedtime);
